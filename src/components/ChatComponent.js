...
function ChatComponent() {
  ...
  useEffect(() => {
    // Check if chatEndRef is not null before scrolling
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Make an API call to send the user message and receive the chatbot response
  ...
  return (
   ...
   AI assistant 
          ...
          <div className="pr-3 h-[374px] overflow-y-auto">
            ...
            <div ref={chatEndRef}></div> {/* Ensure scrolling to end before user input */}
          </div>
